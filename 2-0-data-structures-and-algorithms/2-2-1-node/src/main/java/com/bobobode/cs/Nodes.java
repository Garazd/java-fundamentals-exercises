...
public class Nodes {
    ...
    public static <T> Node<T> pairOf(T firstElement, T secondElement) {
        final Node<T> first = new Node<>(firstElement);
        first.nextNode = new Node<>(secondElement);
        return first;
    }
    ...
    public static <T> Node<T> closedPairOf(T firstElement, T secondElement) {
        final Node<T> first = new Node<>(firstElement);
        final Node<T> second = new Node<>(secondElement);
        first.nextNode = second;
    ...
    public static <T> Node<T> chainOf(T... elements) {
        ...
        for (int i = 1; i < elements.length; i++) {
            current.nextNode = new Node<>(elements[i]);
